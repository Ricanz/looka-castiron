    ...
    <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
        <div>
            ...
            <p class="breadcrumbs"><span><a href="/dashboard">Dashboard</a></span>
                <span><i class="mdi mdi-chevron-right"></i></span>Tambah Gallery
            </p>
        </div>
        <div>
            <a href="{{ route('gallery.index') }}" class="btn btn-primary"> Lihat Semua
            </a>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="row ec-vendor-uploads">
                        <form class="row g-3" method="post" action="{{ route('gallery.store') }}"
                            ...
                            <div class="col-lg-8">
                                <div class="ec-vendor-upload-detail row g-3">
                                    <div class="col-md-12 mb-2">
                                        ...
                                        <select name="product_id" id="Categories" class="form-select">
