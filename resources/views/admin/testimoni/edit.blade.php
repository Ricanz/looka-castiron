            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="row ec-vendor-uploads">
                        <form class="row g-3" method="post" action="{{ route('testimonial.update', $data->id) }}"
                            ...
                            <div class="col-lg-8">
                                <div class="ec-vendor-upload-detail row g-3">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <input type="text" name="nama" class="form-control slug-title" id="inputEmail4" value="{{ $data->nama }}">
                                    </div>
                                    <div class="col-md-8">
                                        <label for="inputEmail4" class="form-label">Perusahaan</label>
                                        <input type="text" name="instansi" class="form-control" id="inputEmail4" value="{{ $data->instansi }}">
                                    </div>
                                    <div class="col-md-8">
