                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{asset('tlandingPage/assets/images/product-image/39_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{asset('tlandingPage/assets/images/product-image/39_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                                ...
                                                <div class="ec-pro-opt-inner">
                                                    <div class="ec-pro-color">
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/39_1.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/39_2.jpg')}}"
                                                    ...
                                                    <div class="ec-pro-compare">
                                                        <a href="compare.html" class="ec-btn-group compare"
                                                            title="Compare"><img src="{{asset('tlandingPage/assets/images/icons/compare_5.svg')}}"
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{asset('tlandingPage/assets/images/product-image/40_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{asset('tlandingPage/assets/images/product-image/40_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-opt-inner">
                                                    <div class="ec-pro-color">
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/40_1.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/40_1.jpg')}}"
                                                                    data-tooltip="Gray"><span
                                                                        style="background-color:#dddddd;"></span></a></li>
                                                            <li><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/40_2.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/40_2.jpg')}}"
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{asset('tlandingPage/assets/images/product-image/41_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{asset('tlandingPage/assets/images/product-image/41_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-opt-inner">
                                                    <div class="ec-pro-color">
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/41_1.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/41_1.jpg')}}"
                                                                    data-tooltip="Gray"><span
                                                                        style="background-color:#dfdfdf;"></span></a></li>
                                                            <li><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/41_2.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/41_2.jpg')}}"
                                                                    data-tooltip="Orange"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{asset('tlandingPage/assets/images/product-image/42_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{asset('tlandingPage/assets/images/product-image/42_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-opt-inner">
                                                    <div class="ec-pro-color">
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/42_1.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/42_2.jpg')}}"
                                                                    data-tooltip="Gray"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{asset('tlandingPage/assets/images/product-image/43_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{asset('tlandingPage/assets/images/product-image/43_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-opt-inner">
                                                    <div class="ec-pro-color">
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/43_1.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/43_1.jpg')}}"
                                                                    data-tooltip="Gray"><span
                                                                        style="background-color:#cccccc;"></span></a></li>
                                                            <li><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/43_2.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/43_2.jpg')}}"
                                                                    data-tooltip="Orange"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{asset('tlandingPage/assets/images/product-image/44_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{asset('tlandingPage/assets/images/product-image/44_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-opt-inner">
                                                    <div class="ec-pro-color">
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/44_1.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/44_1.jpg')}}"
                                                                    data-tooltip="Gray"><span
                                                                        style="background-color:#ffdf76;"></span></a></li>
                                                            <li><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/44_2.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/44_2.jpg')}}"
                                                                    data-tooltip="Orange"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{asset('tlandingPage/assets/images/product-image/45_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{asset('tlandingPage/assets/images/product-image/45_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-opt-inner">
                                                    <div class="ec-pro-color">
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/45_1.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/45_2.jpg')}}"
                                                                    data-tooltip="Gray"><span
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 ec-product-content">
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-image-outer">
                                            <div class="ec-pro-image">
                                                <a href="product-left-sidebar.html" class="image">
                                                    <img class="main-image" src="{{asset('tlandingPage/assets/images/product-image/46_1.jpg')}}"
                                                        alt="Product" />
                                                    <img class="hover-image" src="{{asset('tlandingPage/assets/images/product-image/46_2.jpg')}}"
                                                        alt="Product" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div class="ec-pro-option">
                                                <div class="ec-pro-opt-inner">
                                                    <div class="ec-pro-color">
                                                        <ul class="ec-opt-swatch ec-change-img">
                                                            <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/46_1.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/46_1.jpg')}}"
                                                                    data-tooltip="Gray"><span
                                                                        style="background-color:#202020;"></span></a></li>
                                                            <li><a href="#" class="ec-opt-clr-img"
                                                                    data-src="{{asset('tlandingPage/assets/images/product-image/46_2.jpg')}}"
                                                                    data-src-hover="{{asset('tlandingPage/assets/images/product-image/46_2.jpg')}}"
                                                                    data-tooltip="Orange"><span
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 col-xs-6 ec-right-banner-content dis-n-767">
                        <div class="ec-right-banner-inner">
                            <div class="right-banner-block">
                                <img class="right-banner-img" src="{{asset('tlandingPage/assets/images/banner/22.png')}}" alt="Banner" />
                    ...
                    <div class="ec-test-outer">
                        <ul id="ec-testimonial-slider">
                            <li class="ec-test-item">
                                <div class="ec-test-inner">
                                    <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                            src="{{asset('tlandingPage/assets/images/testimonial/1.jpg')}}" /></div>
                            ...
                            <li class="ec-test-item">
                                <div class="ec-test-inner">
                                    <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                            src="{{asset('tlandingPage/assets/images/testimonial/2.jpg')}}" /></div>
                                    <div class="ec-test-content">
                                        <div class="ec-test-name">david james</div>
                                        <div class="ec-test-designation">united states of america</div>
                                        <div class="ec-test-rating">
                            ...
                            <li class="ec-test-item">
                                <div class="ec-test-inner">
                                    <div class="ec-test-img"><img alt="testimonial" title="testimonial"
                                            src="{{asset('tlandingPage/assets/images/testimonial/3.jpg')}}" /></div>
                                    <div class="ec-test-content">
                                        <div class="ec-test-name">david james</div>
                                        <div class="ec-test-designation">united states of america</div>
                                        <div class="ec-test-rating">
                        ...
                        <ul id="ec-brand-slider">
                            <li class="ec-brand-item">
                                <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                            src="{{asset('tlandingPage/assets/images/brand-image/1.png')}}" /></a></div>
                            </li>
                            <li class="ec-brand-item">
                                <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                            src="{{asset('tlandingPage/assets/images/brand-image/2.png')}}" /></a></div>
                            </li>
                            <li class="ec-brand-item">
                                <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                            src="{{asset('tlandingPage/assets/images/brand-image/3.png')}}" /></a></div>
                            </li>
                            <li class="ec-brand-item">
                                <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                            src="{{asset('tlandingPage/assets/images/brand-image/4.png')}}" /></a></div>
                            </li>
                            <li class="ec-brand-item">
                                <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                            src="{{asset('tlandingPage/assets/images/brand-image/5.png')}}" /></a></div>
                            </li>
                            <li class="ec-brand-item">
                                <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                            src="{{asset('tlandingPage/assets/images/brand-image/6.png')}}" /></a></div>
                            </li>
                            <li class="ec-brand-item">
                                <div class="ec-brand-img"><a href="#"><img alt="brand" title="brand"
                                            src="{{asset('tlandingPage/assets/images/brand-image/7.png')}}" /></a></div>
                            </li>
                        </ul>
                    </div>
                </div>
