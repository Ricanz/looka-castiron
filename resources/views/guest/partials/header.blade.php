<head>
   ...
   <!-- site Favicon -->
   <link rel="icon" href="{{asset('tlandingPage/assets/images/favicon/favicon-5.png')}}" sizes="32x32" />
   <link rel="apple-touch-icon" href="{{asset('tlandingPage/assets/images/favicon/favicon-5.png')}}" />
   <meta name="msapplication-TileImage" content="{{asset('tlandingPage/assets/images/favicon/favicon-5.png')}}" />
