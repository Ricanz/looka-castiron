<div class="ec-cp-style cp-right-bottom">
    ...
    <script src="{{asset('tlandingPage/assets/js/plugins/chat-pro.js')}}"></script>

    <!-- Main Js -->
    <script src="{{asset('tlandingPage/assets/js/vendor/index.js')}}"></script>
    <script src="{{asset('tlandingPage/assets/js/demo-5.js')}}"></script>
